        ...
        <div class="row">
            ...
            <div class="col-md-4 text-center mb-3 mb-md-0">
                ...
                <div class="d-flex flex-column">
                    ...
                    <a href="${pageContext.request.contextPath}/complaint_history" class="text-light text-decoration-none small py-1">Track Complaint</a>
                </div>
            </div>
            <div class="col-md-4 text-center text-md-end">
                <h6>Contact Information</h6>
                <p class="small mb-1"><i class="fas fa-phone-alt me-2"></i> Helpline: 1800-123-4567</p>
                <p class="small mb-1"><i class="fas fa-envelope me-2"></i> Email: civiccitizenhelpdesk@gmail.com</p>
